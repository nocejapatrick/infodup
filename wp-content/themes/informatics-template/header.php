...
<head>
	...
	<meta name="description" content="Informatics College">
	<link rel="profile" href="https://www.informatics.edu.ph/wp-content/uploads/2018/09/cropped-cropped-Logo-192x192-32x32.png">
	...
	<div class="fb-customerchat"
	  ...
	  page_id="114527305251290">
		...
		<?php 
		   if(is_home()){	
		?>
	<div class="whole-pop-up-container">
        <div class="pop-up-container">
            <div class="close-container">
                <i class="fa fa-times" aria-hidden="true"></i>
            </div>
            <h4>Enrollment is still on-going for <a href="/programs/senior-high-school-tracks/" target="_blank">Senior High School</a> and 
                <a href="/programs/bachelors-degree-programs/" target="_blank">College Programs.</a></h4>
           
                <p>We assure parents and students that Informatics is highly prepared to conduct Online
                    Schooling across our Senior High School Strands and College Programs. Not only has
                    the school been using various technologies in the last years, Informatics combines the
                    best education technologies from Skillsoft Percipio (Top Learning Portal/LMS in 2018),
                    D2L Brightspace (Best K-12 LMS in 2019) and Microsoft Teams so our students learn
                    effectively, safely and with motivation anywhere. Course Materials are accessible on
                    any device including a smart phone.</p>
                <p>For more details, you may contact our <a href="/informatics-branches/" target="_blank">branches</a>. To apply, you may use the online
                    application forms <a href="/apply-online-v2/" target="_blank">here.</a> </p>
                <p>View our Online Schooling FAQs <a href="/faqs/" target="_blank"> here</a>. Watch our <a href="https://www.youtube.com/watch?v=m7NnqXlksCk&feature=youtu.be" target="_blank">video</a> for an overview of how
                    Informatics conducts Online Schooling.</p>
                <p>Some Informatics Branches are in an area that is currently under Enhanced Community
                    Quarantine (ECQ) and General Community Quarantine (GCQ). Online learning is what
                    we offer to help our students not miss out on education during this pandemic.</p>
		...
		<nav id="site-navigation" class="main-navigation navbar navbar-expand-lg">
			...
			<button class="navbar-toggler" type="button" data-toggle="collapse" data-target=".navbar-collapse" aria-controls="primary-menu-wrap" aria-expanded="false" aria-label="Toggle navigation">
				...
				<div class="site-branding-text">
					...
					<div id="search-icon-wrap-1" style="margin-right:-20px;"><i id="search-icon-1" class="fas fa-search"></i><?php if(is_woocommerce() || is_cart() || is_checkout() || is_account_page() || is_page([3340])){?>
				<a href="<?php echo wc_get_cart_url(); ?>">
				<i id="search-icon-2" class="fas fa-shopping-cart"></i>
				</a><span class="cart-num"><?php echo WC()->cart->get_cart_contents_count(); ?></span>
				<?php }?></div>
					<button class="navbar-toggler" type="button" data-toggle="collapse" data-target=".social-media-collapse" aria-controls="social-media-dropdown" aria-expanded="false" aria-label="Toggle navigation">
						<div id="dots-icon-wrap" class="mr-md-1 mr-0"><i class="fas fa-ellipsis-h" style="color:#007bff"></i></div>
					</button>		
					 ...
					 <div id="social-media-dropdown" class="collapse social-media-collapse">
						<ul id="social-media-menu" class="navbar-nav ml-auto">
							<li class="nav-item menu-item menu-item-type-custom menu-item-object-custom menu-item-home">
								<a href="#" class="nav-link"><i class='fab fa-facebook mr-2'></i><span class="social-para">Facebook</span></a>
							</li>
							<li class="nav-item menu-item menu-item-type-custom menu-item-object-custom menu-item-home">
								<a href="#" class="nav-link"><i class='fab fa-twitter-square mr-2'></i><span class="social-para">Twitter</span></a>
							</li>
							<li class="nav-item menu-item menu-item-type-custom menu-item-object-custom menu-item-home">
								<a href="#" class="nav-link"><i class='fab fa-youtube-square mr-2'></i><span class="social-para">Youtube</span></a>
							</li>
							<li class="nav-item menu-item menu-item-type-custom menu-item-object-custom menu-item-home">
			...
			if(is_woocommerce() || is_cart() || is_checkout() || is_account_page() || is_page([3340])){
				wp_nav_menu( array(
				...
				?>
					<div id="search-icon-wrap-2" class="pl-2">
				<i id="search-icon-2" class="fas fa-search"></i>
				<?php if(is_woocommerce() || is_cart() || is_checkout() || is_account_page() || is_page([3340])){?>
				<a href="<?php echo wc_get_cart_url(); ?>">
				<i id="search-icon-2" class="fas fa-shopping-cart"></i>
				</a><span class="cart-num"><?php echo WC()->cart->get_cart_contents_count(); ?></span>
				<?php }?>
